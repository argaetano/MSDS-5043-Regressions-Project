...
distribution shape to it as well.  W2MiDTNo has a higher frequncy.
...
RentRate and OperExp have a moderate positive correlation. RentRate and SqFt have a strong positive correlation.  RentRate and Taxes share the same correlation of .584. SqFt and Taxes have a perfect correlation
of 1.00.  Other correlations to note are a negative correlation of -.366 between VacRate and OperExp, a very small correlation between Age and OperExp, and a very small negative correlation between Age and RentRate.  


#3)  The identification and evaluation of a suitable regression model for predicting rental rates

A manual iteration selection method will be used first.  The results will later be compared to results from Stepwise and All Subsets Regression (ASR) selection methods in order to select the most appropriate linear model.
...
*All variables are highly significant.  Model m.1's summary shows an increased Adjusted R-squared value of .7313, an increased F-Statistic of 68.35, and no notable change in the p-value.*
