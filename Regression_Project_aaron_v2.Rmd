...
##c) All Subsets Regression Iteration (ASR)
...
**Models m.step and m.sub1 appear to to have the same values for F-Statistic and Adjusted R-squared the most appropriate predictive model.  Further examination will need to be conducted to determine the most appropriate model.**
