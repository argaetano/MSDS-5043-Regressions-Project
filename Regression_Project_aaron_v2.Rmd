...
head(comm_prop) #Head function will retun the FIRST 6 rows of the dataset
tail(comm_prop) #Tail function will retun the LAST 6 rows of the dataset
summary(comm_prop) #Summary function returns a compact analysis of the dataset

kable(head(comm_prop,5), format = "html", align='c', caption = "Example of Data")
```
